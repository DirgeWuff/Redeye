...
namespace RE::Core {
    ...
    std::string soundIdToStr(const soundId& id) {
        switch (id) {
            case soundId::PLAYER_FOOTSTEP: return "PLAYER_FOOTSTEP";
            case soundId::PLAYER_LAND: return "PLAYER_LAND";
            default: return "No such soundId";
        }
    }

    std::string musicIdToStr(const musicId& id) {
        switch (id) {
            case musicId::BACKGROUND_NOISE: return "BACKGROUND_NOISE";
            default: return "No such musicId";
        }
    }
